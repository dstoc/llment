...
- Layout
  ...
  - text input field at the bottom
    ...
    - recognizes `/` commands
      - `/` opens a popup with `/quit`, `/clear`, `/redo`, `/pop`, `/continue`, `/thought`, `/response`, `/save`, `/load`, `/model`, `/provider`, `/prompt`, `/role`, and `/agent-mode`
      ...
      - `/pop` removes the last assistant response part or message from chat history
